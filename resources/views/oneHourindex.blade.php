...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        // AJAX request
        $.ajax({
            url: 'http://cryptoscannerpro.com/candlesticks',
            data :{symbol:symbol,interval:interval},
            type: 'post',
            success: function(datas) { 
                data=datas[0];
                points=datas[1];
                console.log(points.low_price_2);
                ...
                subtitle: { 
                    text: symbol+' - Bullish Divergence - '+interval
                },
                series: [ {
                            type: 'candlestick',
                            id: symbol,
                        ...
                        },
                        {
                            ...
                            color: '#ffe37d',
                            data:[  
                                [parseFloat(points.time_1),parseFloat(points.low_price_1)],
                                [parseFloat(points.time_2),parseFloat(points.low_price_2)],
                                //[parseFloat(points.time_3),parseFloat(points.low_price_3)],
                            ]
                        },
                        {
                            type: 'line',
                            ...
                            yAxis: 1,
                            data:[  
                                    [parseFloat(points.time_1),parseFloat(parseFloat(Math.round(points.low_rsi_1 * 100) / 100).toFixed(2))],
                                    [parseFloat(points.time_2),parseFloat(parseFloat(Math.round(points.low_rsi_2 * 100) / 100).toFixed(2))],
                                    //[parseFloat(points.time_3),parseFloat(parseFloat(Math.round(points.low_rsi_3 * 100) / 100).toFixed(2))],
                                ]
                        }]
                });
            }
