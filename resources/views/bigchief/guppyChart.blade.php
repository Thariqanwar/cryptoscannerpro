...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        // AJAX request
        $.ajax({
            url: '{{ route("guppycandlesticks") }}',
            data :{symbol:symbol,interval:interval,limit:limit},
            type: 'post',
            success: function(datas) { 
                data=datas[0];
                points3=datas[1]['short'][3];
                points5=datas[1]['short'][5];
                points8=datas[1]['short'][8];
                points10=datas[1]['short'][10];
                points12=datas[1]['short'][12];
                points15=datas[1]['short'][15];
                
                longTermPoints30=datas[1]['long'][30];
                longTermPoints35=datas[1]['long'][35];
                longTermPoints40=datas[1]['long'][40];
                longTermPoints45=datas[1]['long'][45];
                longTermPoints50=datas[1]['long'][50];
                longTermPoints60=datas[1]['long'][60];

                volume = datas[2];

                console.log(datas[1]['long']);
                ...
                title: { 
                    text: 'Guppy Multiple Moving Average' 
                },
                subtitle: { 
                    text: symbol+' - Guppy Multiple Moving Average - '+interval
                },
                series: [ 
                            {
                                type: 'candlestick',
                            ...
                            {type: 'line', color: '#ffe37d', data:points3 },
                            {type: 'line', color: '#ffe37d', data:points5 },
                            {type: 'line', color: '#ffe37d', data:points8 },
                            {type: 'line', color: '#ffe37d', data:points10 },
                            {type: 'line', color: '#ffe37d', data:points12 },
                            {type: 'line', color: '#ffe37d', data:points15 },
                            
                            {type: 'line', color: '#ff4800', data:longTermPoints30 },
                            {type: 'line', color: '#ff4800', data:longTermPoints35 },
                            {type: 'line', color: '#ff4800', data:longTermPoints40 },
                            {type: 'line', color: '#ff4800', data:longTermPoints45 },
                            {type: 'line', color: '#ff4800', data:longTermPoints50 },
                            {type: 'line', color: '#ff4800', data:longTermPoints60 },
