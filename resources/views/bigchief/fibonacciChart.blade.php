...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        // AJAX request
        $.ajax({
            url: '{{ route("fibonaccicandlesticks") }}',
            data :{symbol:symbol,interval:interval,limit:limit},
            type: 'post',
            success: function(datas) { 
                data     =datas[0];
                pcntg0   =datas[1]['pcntg0'];
                pcntg236 =datas[1]['pcntg236'];
                pcntg382 =datas[1]['pcntg382'];
                pcntg50  =datas[1]['pcntg50'];
                pcntg618 =datas[1]['pcntg618'];
                pcntg100 =datas[1]['pcntg100'];
                volume = datas[2];
                ...
                title: { 
                    text: 'Fibonacci Retracement Chart' 
                },
                subtitle: { 
                    text: symbol+' - Fibonacci Retracement Chart - '+interval
                },
                series: [ 
                            {
                                type: 'candlestick',
                            ...
                            {name: '0%',type: 'line', color: '#fff', data:pcntg0 },
                            {name: '23.6%',type: 'line', color: '#1322d6', data:pcntg236 },
                            {name: '38.2%',type: 'line', color: '#ffe37d', data:pcntg382 },
                            {name: '50%',type: 'line', color: '#8106a7', data:pcntg50 },
                            {name: '61.8%',type: 'line', color: '#1e6d04', data:pcntg618 },
                            {name: '100%',type: 'line', color: '#fb0303', data:pcntg100 },
