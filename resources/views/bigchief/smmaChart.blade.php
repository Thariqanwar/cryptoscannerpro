...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        // AJAX request
        $.ajax({
            url: '{{ route("smmaCandleSticks") }}',
            data :{symbol:symbol,interval:interval},
            type: 'post',
            success: function(datas) { 
                data=datas[0];
                ffpoints=datas[1];
                ffsmmapoints=datas[2];
                volume=datas[3];
                ...
                title: { 
                    text: 'Smooth Moving Average' 
                },
                subtitle: { 
                    text: symbol+' - Smooth Moving Average - '+interval
                },
                series: [ 
                        {
                            type: 'candlestick',
                        ...
                        { name: '50 ma', type: 'line', color: '#ffe37d', data:ffpoints, lineWidth:4 },
                        { name: '50 smma', type: 'line', color: '#ff4800', data:ffsmmapoints },
