...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        // AJAX request
        $.ajax({
            url: '{{ route("resistanceCandlesticks") }}',
            ...
            success: function(datas) {
                ...
                Highcharts.stockChart('container', {
                    ...
                    title: {
                        text: 'Horizontal Resistance Level'
                    },
                    subtitle: {
                        text: symbol+' - Horizontal Resistance Level - '+interval
                    },
                    series: [ {
                                type: 'candlestick',
                                id: symbol,
...

                            {
                                ...
                                color: '#ffffff78',
                                data: [
                                    [parseFloat(points.time_1), parseFloat(points.peak_1)],
                                    [parseFloat(points.time_2), parseFloat(points.peak_2)],
                                    [parseFloat(points.time_3), parseFloat(points.peak_3)],
                                    [parseFloat(points.time_4), parseFloat(points.peak_4)],
                                ],
