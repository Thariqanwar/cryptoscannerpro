...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        // AJAX request
        $.ajax({
            url: '{{ route("MaCandleSticks") }}',
            data :{symbol:symbol,interval:interval},
            type: 'post',
            success: function(datas) { 
                data=datas[0];
                ffpoints=datas[1];
                twohndpoints=datas[2];
                ...
                subtitle: { 
                    text: symbol+' - Moving Average - '+interval
                },
                series: [ {
                            type: 'candlestick',
                            id: symbol,
                       ...
                       
                        {
                            ...
                            data:ffpoints
                            // [  
                            //     [parseFloat(1572130799999 ),parseFloat(0.00009)],
                            //     [parseFloat(1572140699999 ),parseFloat(0.00007)],
